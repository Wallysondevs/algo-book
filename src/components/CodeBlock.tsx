...
export default function CodeBlock({ code, language = "pseudocode", label }: { code: string; language?: string; label?: string }) {
  ...
  return (
    <div className="relative my-4 group">
      <div className="flex items-center justify-between bg-algo-teal-dark text-algo-orange text-xs px-4 py-2 rounded-t-lg font-mono">
